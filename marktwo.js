...
function fetchData(){
    fetch('http://localhost/marktwo.php',{
        method:'GET',
        headers:{
...
function dataLog(data){
    ...
    for(const department in studentByDepartment){
        if(department == "computer science" ||department == "computerscience"||department == "cs"||department == "bca"||department == "bio chemistry"||department=="micro biology"){
        ...
        else if(department == "Bcom" || department == "bca"||department == "bcom a&f"){
            const tablecontainer = document.getElementById('tablecontainer');
            var heading = document.createElement('h2');
            heading.textContent = department;
            tablecontainer.appendChild(heading);
